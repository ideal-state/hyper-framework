...
/**
 * <p>EventHandlerChain</p>
 *
 * <p>Created on 2023/3/15 13:00</p>
 *
 * @author ketikai
 * @since 1.0.0
 */
public interface EventHandlerChain {
    ...
    void doHandleEvent(@NotNull Object event);

    void addEventHandler(@NotNull EventHandler eventHandler);

    EventHandler removeEventHandler(@NotNull EventHandler eventHandler);

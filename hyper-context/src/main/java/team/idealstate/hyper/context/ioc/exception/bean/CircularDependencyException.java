...
/**
 * <p>CircularDependencyException</p>
 *
 * <p>Created on 2023/3/23 17:14</p>
 *
 * @author ketikai
 * @since 1.0.0
 */
public class CircularDependencyException extends BeanException {
    ...
    @Serial
    private static final long serialVersionUID = -5573929563439480456L;

    public CircularDependencyException(@NotNull BeanDefinition beanDefinition, @Nullable String message) {
        super(beanDefinition, getOrDefault(message));
    }

    public CircularDependencyException(@NotNull BeanDefinition beanDefinition, @Nullable String message, Throwable cause) {
        super(beanDefinition, getOrDefault(message), cause);
    }

    @NotNull
    private static String getOrDefault(@Nullable String message) {
        return StringUtils.isNullOrBlank(message) ? "circular dependency" : message;
    }
}
